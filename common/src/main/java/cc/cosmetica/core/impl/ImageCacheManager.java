...
public class ImageCacheManager {
    ...
    public void saveSync() throws IOException {
        Logging.getInstance().info("Saving cosmetica image cache metadata (sync)");
        this.save(this.keep, this.entries);
    }

    public void saveAsync() {
        // gather data on main thread, save off thread
        Logging.getInstance().info("Saving cosmetica image cache metadata (async)");
    ...
    public void clearOldEntries() {
        Logging.getInstance().info("Clearing old cosmetica image cache entries");
        ...
        Logging.getInstance().info("Cleared {} old cache entries in {} ms (cosmetica image cache)", count, delay);
    }
