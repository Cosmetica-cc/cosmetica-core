...
public class ImageCacheManager {
    ...
    public void saveSync() throws IOException {
        Logging.getInstance().debug(LoggingCategory.ASSETS, "Saving cosmetica image cache metadata (sync)");
        this.save(this.keep, this.entries);
    }

    public void saveAsync() {
        // gather data on main thread, save off thread
        Logging.getInstance().debug(LoggingCategory.ASSETS, "Saving cosmetica image cache metadata (async)");
    ...
    public void clearOldEntries() {
        Logging.getInstance().debug(LoggingCategory.ASSETS, "Clearing old cache entries");
        ...
        Logging.getInstance().debug(LoggingCategory.ASSETS, "Cleared {} old cache entries in {} ms", count, delay);
    }
